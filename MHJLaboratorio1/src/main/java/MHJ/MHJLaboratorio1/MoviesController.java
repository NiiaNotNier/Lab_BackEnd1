...
public class MoviesController {
    public static ArrayList<Movies> movies = new ArrayList(Arrays.asList(
            new Movies(1, "High School Musical", 2006, "Musica para jovenes"),
            new Movies(2, "Burlesque", 2010, "Musica para adultos"),
            new Movies(3, "Superman", 1978, "Thriller superheroes"),
            new Movies(4, "Solo en Casa", 1990, "Pelicula que te hara llorar de la risa"),
            new Movies(5, "Sé lo que hicisteis el último verano", 1997, "Miedo asegurado"),
            new Movies(6, "La huerfana", 2016, "Bu"),
